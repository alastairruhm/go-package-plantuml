...
var testdataPath = gopathDir + "/src/github.com/alastairruhm/go-package-plantuml/testdata"
...
func Test_InterfacesSign(t *testing.T) {
	...
	assert.Equal(t, "github.com/alastairruhm/go-package-plantuml/testdata/a", interfaceMeta.PackagePath, "error in interfaceMeta")
	...
	assert.Equal(t, "github.com/alastairruhm/go-package-plantuml/testdata/a", structmeta.PackagePath, "error in structmeta")
...
func Test_complex(t *testing.T) {
	...
	interfaceMeta := analysisTool1.interfaceMetas[0]
	assert.Equal(t, "IA", interfaceMeta.Name)
	assert.Equal(t, "Add(github.com/alastairruhm/go-package-plantuml/testdata/b/sub.SubSA,sync.Locker,github.com/alastairruhm/go-package-plantuml/testdata/b.B,github.com/alastairruhm/go-package-plantuml/testdata/b/suba.SubSa1)", interfaceMeta.MethodSigns[0])
